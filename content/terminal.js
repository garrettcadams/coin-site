function animate(typewriter) {
    var amount = localStorage.getItem("#X04Pokecoins");
    var delay;
    var instant;

    if(amount >= 0.1 && amount < 0.35) {
        delay = 100;
        instant = true;
    }

    if(amount >= 0.35 && amount < 0.70) {
        delay = 200;
        instant = true;
    }

    if(amount >= 0.70 && amount < 1.40) {
        delay = 500;
        instant = true;
    }

    if(amount >= 1.40 && amount <= 2.50) {
        delay = 500;
        instant = false;
    }
    ...
    sequence = [
        ...
        },
        {
            ...
            callback: function () {
                ...
                //audioElement.setAttribute('src', 'assets/content/chaching.mp3');
